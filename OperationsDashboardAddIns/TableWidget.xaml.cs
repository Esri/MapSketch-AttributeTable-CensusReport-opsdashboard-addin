...
namespace OperationsDashboardAddIns
{
  ...
  [ExportMetadata("DisplayName", "Attribute Table")]
  [ExportMetadata("Description", "Shows features's attributes from a data source on a table")]
  ...
  ///<summary>
  /// Show feature's attribute from a data source on a table
  ///</summary>
  public partial class TableWidget : UserControl, IWidget, IDataSourceConsumer
  {
    #region Properties    
    //We will serialized the dataSource id, not the entire data source object
    [DataMember(Name = "dataSourceId")]
    public string DataSourceId { get; set; }

    public ESRI.ArcGIS.OperationsDashboard.DataSource DataSource { get; private set; }

    #region Other properties to be serialized
